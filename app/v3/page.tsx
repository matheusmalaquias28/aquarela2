    ...
    <main className="flex w-full flex-col" style={{ "--color-brand": theme.brandColor } as React.CSSProperties}>
      ...
      <div className="flex items-center justify-center bg-red-600 p-[10px]">
        <p className="text-center font-display text-[12px] font-semibold leading-[1.6] text-white">
          Essa oferta não vai durar muito... <span aria-hidden>|</span> <Countdown />
        </p>
      </div>
      <StickyCta />
      ...
      <section className="mx-auto flex w-full max-w-[480px] flex-col items-center gap-[16px] px-[10px] pt-0 text-center">
        ...
        <img
          src="/hero-v3.webp"
          alt="Aluna segurando quadro com aquarela de paisagem natural"
          width={766}
          height={766}
          fetchPriority="high"
          loading="eager"
          decoding="sync"
          className="mx-auto mt-[10px] w-full max-w-[306px] rounded-[10px]"
        />
        <h1 className="font-display text-[32.3px] font-semibold leading-[0.9] text-ink">
